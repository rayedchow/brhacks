    ...
    <>
      ...
      <div className="mt-16 flex w-full h-full justify-center">
        <div className="text-5xl text-[#52525b] w-[50%] leading-relaxed">
          <i>Redefining the Process of Waste Management:</i> At the <span className="text-[#059669] font-medium">Trash</span>, <span className="text-[#059669] font-medium">Recyclable</span>, and <span className="text-[#059669] font-medium">Biodegradable</span> Level
        </div>
